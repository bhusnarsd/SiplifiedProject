...
const createSaralInfo4 = catchAsync(async (req, res) => {
  const saral = await saralInformation4Service.createSaralInfo4(req.body.scode, req.body);
...
const getSaralInfoBysaralId = catchAsync(async (req, res) => {
  ...
  const result = await saralInformation4Service.getSaralInfo1BySaralId(scode);
  res.send(result);
});
module.exports = {
  createSaralInfo4,
